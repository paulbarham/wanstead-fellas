    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: '#F2F3EE' }}>
      <div className="w-full" style={{ maxWidth: 430 }}>
        ...
        <div className="rounded-2xl p-6" style={{ background: '#FFFFFF', border: '1px solid #E2E4DC' }}>
          <h2 className="text-lg font-semibold text-[#18201A] mb-5">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: '#647060' }}>First Name</label>
                <input
                  type="text"
                  value={form.name}
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5" style={{ color: '#647060' }}>Surname</label>
                <input
                  type="text"
                  value={form.surname}
            ...
            <div>
              <label className="block text-sm font-medium mb-1.5" style={{ color: '#647060' }}>Age Group</label>
              <select
