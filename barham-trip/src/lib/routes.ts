...
export const routes: DriveRoute[] = [
  ...
  },
  {
    ...
    via: 'Piedras Blancas · US-101 · Santa Barbara',
    distance: '~230 mi · 5 hrs driving + stops',
    offlineArea: 'Cambria → Santa Barbara → Santa Monica',
    waypoints: [
      { name: 'Cambria', lat: 35.5641, lng: -121.0807, note: 'Moonstone Beach & lunch' },
      { name: 'Piedras Blancas', lat: 35.6663, lng: -121.2846, note: 'elephant seals (10 min N)' },
      { name: 'Pismo Beach', lat: 35.1428, lng: -120.6413, note: '20-min stop' },
      { name: 'Santa Barbara', lat: 34.4208, lng: -119.6982, note: 'courthouse & wharf' },
