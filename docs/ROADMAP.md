...
_Last updated: 2026-09-01 (Added roadmap row: RTG-spread post-draft swap pass — the next-step balancer fix now that real card stats are populated. Earlier today: squad ratings audit · mig 088 · push adoption drive · SW v54 · monthly personal review · migs 086+087 · rivalry cards v1+v1.5 · migs 084+085 · decisions log · mig 082 · monthly sub-chase · mig 083.)_
